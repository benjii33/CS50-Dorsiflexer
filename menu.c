...
void menu_ACTUATOR_MAIN_render() {
    ...
    // +
    LCD_rect(30, 120, 60, 60, 0x000000);
    LCD_rect(50, 125, 20, 50, 0xFFFFFF);
    LCD_rect(35, 140, 50, 20, 0xFFFFFF);

    // -
    LCD_rect(110, 120, 60, 60, 0x000000);
    LCD_rect(115, 140, 50, 20, 0xFFFFFF);
